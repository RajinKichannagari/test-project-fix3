...
!!! info
    ...
    **Source Code Repository:** [https://github.com/RajinKichannagari/test-project-fix3](https://github.com/RajinKichannagari/test-project-fix3)

    **GitOps Repository:** [https://github.com/RajinKichannagari/test-project-fix3-gitops](https://github.com/RajinKichannagari/test-project-fix3-gitops)

# **Usage**

To access the test-project-fix3 application that was deployed using the Software Template, complete the following instructions:
